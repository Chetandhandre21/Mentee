...
<div className="logp">
      <div className="par">
        <div className="two">
          <div className="one1">
            <div className="hed90">
                <h3 className="hedee15">Login Student</h3>
                
            </div>        <form id="signupForm" onSubmit={handleSubmit}>
            ...
            <div className="btnl33"> <button type="submit" className="login22">LOG IN</button> </div></form>
            <div className="cap">
            <Link to="/student/signup">
            <h5 className="caption35">Don't have an Account?</h5>
            </Link>
